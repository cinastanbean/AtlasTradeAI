...
from atlas_trade_ai.services.dashboard_service import DashboardService
from atlas_trade_ai.services.demo_scenario_service import DemoScenarioService
...
class AppContainer:
    def __init__(self) -> None:
        self.store = build_seed_store(os.getenv("ATLAS_DB_PATH"))
